...
//    if ([model.date_complete isEqualToString:@"<null>"]) {
//        self.saying.text = @"默认故事集";
//    }else{
//    //日期转换
////        NSDate *data1 = [NSDate alloc] initWithTimeIntervalSince1970:<#(NSTimeInterval)#>
...
//  
//        self.saying.text = [NSString stringWithFormat:@"%@•%@地点故事",nowTimeStr,model.spot_count];}
